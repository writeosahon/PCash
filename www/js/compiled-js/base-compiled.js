            ...
            addTransactionHistory: function addTransactionHistory(transactionDataObject) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    Promise.resolve(intel.security.secureStorage.read({ 'id': 'postcash-transaction-history-collection' })).then(function (instanceId) {
                        ...
                        if (transactionDataArray.length == 25) {
            ...
            getTransactionHistoryById: function getTransactionHistoryById(transactionRef) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    Promise.resolve(intel.security.secureStorage.read({ 'id': 'postcash-transaction-history-collection' })).then(function (instanceId) {
                        ...
                        if (!transactionData) {
                            // transaction data object was NOT found
                            resolve(null);
                        } else {
                            // transaction data was found
                ...
                return new Promise(function (resolve, reject) {
                    Kinvey.initialize({
                        ...
                        return new Promise(function (resolve1, reject1) {
                            // Promise checks if a has been created or logged in
                            if (Kinvey.User.getActiveUser()) {
                                // user has been created, so kinvey has been fully initialised
