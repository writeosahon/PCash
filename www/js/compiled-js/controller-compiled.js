...
utopiasoftware.saveup.controller = {
     ...
     */
    pinSecurityCheckPreShow: function pinSecurityCheckPreShow() {
    ...
    verifyAccountPageViewModel: {
        ...
        pageInit: function pageInit(event) {
            ...
            function loadPageOnAppReady() {
                ...
                Promise.resolve(utopiasoftware.saveup.sortBanksData()).then(function (bankArrayData) {
    ...
    myCardsPageViewModel: {
        ...
        pageInit: function pageInit(event) {
            ...
            function loadPageOnAppReady() {
                ...
                $('#my-cards-pull-hook', $thisPage).on("changestate", function (event) {
                    ...
                    switch (event.originalEvent.state) {
                        case 'initial':
                            ...
                            $('#my-cards-pull-hook-fab', event.originalEvent.pullHook).html('<ons-icon icon="fa-long-arrow-down" size="24px"></ons-icon>');
                            break;

                        case 'preaction':

                            $('#my-cards-pull-hook-fab', event.originalEvent.pullHook).html('<ons-icon icon="fa-long-arrow-up" size="24px"></ons-icon>');
                            break;

                        case 'action':
                            $('#my-cards-pull-hook-fab', event.originalEvent.pullHook).html('<ons-icon icon="fa-repeat" size="24px" spin></ons-icon>');
                            break;
                    }
                });
                ...
                $('#my-cards-pull-hook', $thisPage).get(0).onAction = function (loadingDone) {
                    ...
                    utopiasoftware.saveup.controller.myCardsPageViewModel.loadCardData().then(function (cardsArray) {
                        // the cards array collection has been returned
                        if (cardsArray.length == 0) {
                            // there are no card data available
         ...
         */
        addCardButtonClicked: function addCardButtonClicked() {
    ...
    addCardPageViewModel: {
        ...
        pageInit: function pageInit(event) {
            ...
            function loadPageOnAppReady() {
                ...
                utopiasoftware.saveup.controller.addCardPageViewModel.formValidator.on('field:error', function (fieldInstance) {
                    ...
                    if ($(fieldInstance.$element).is('#add-card-card-number')) {
                        // it is the card number input
                ...
                utopiasoftware.saveup.controller.addCardPageViewModel.formValidator.on('field:success', function (fieldInstance) {
                    ...
                    if ($(fieldInstance.$element).is('#add-card-card-number')) {
                        ...
                        if ($('#add-card-verify-card').is(":checked")) {
                            //user asked for remote validation
                            ...
                            switch (utopiasoftware.saveup.controller.addCardPageViewModel.newCardBrand) {
                                case "Mastercard":
                                    if (utopiasoftware.saveup.controller.addCardPageViewModel.newCardLocale == "local") {
                                        ...
                                        $('#add-card-image').attr("src", "css/app-images/mastercard-local-" + utopiasoftware.saveup.controller.addCardPageViewModel.cardImageRandomNum + ".png");
                                        // update the card type display name
                                        $('#add-card-image-type').html("Mastercard");
                                    } else {
                                        // this is a international mastercard
                                        $('#add-card-image').attr("src", "css/app-images/mastercard-international-" + utopiasoftware.saveup.controller.addCardPageViewModel.cardImageRandomNum + ".png");
                                        // update the card type display name
                                ...
                                case "Visa":
                                    if (utopiasoftware.saveup.controller.addCardPageViewModel.newCardLocale == "local") {
                                        ...
                                        $('#add-card-image').attr("src", "css/app-images/visacard-local-" + utopiasoftware.saveup.controller.addCardPageViewModel.cardImageRandomNum + ".png");
                                        // update the card type display name
                                        $('#add-card-image-type').html("Visa");
                                    } else {
                                        // this is a international Visa card
                                        $('#add-card-image').attr("src", "css/app-images/visacard-international-" + utopiasoftware.saveup.controller.addCardPageViewModel.cardImageRandomNum + ".png");
                                        // update the card type display name
                                ...
                                case "Verve":
                                    if (utopiasoftware.saveup.controller.addCardPageViewModel.newCardLocale == "local") {
                                        ...
                                        $('#add-card-image').attr("src", "css/app-images/verve-local-" + utopiasoftware.saveup.controller.addCardPageViewModel.cardImageRandomNum + ".png");
                                        // update the card type display name
                            ...
                            // user did not ask for remote card validation
                            // hide the card image row
                            $('#add-card-image-container', $thisPage).css("display", "none");
                        }
                    }
                ...
                utopiasoftware.saveup.controller.addCardPageViewModel.formValidator.on('form:success', utopiasoftware.saveup.controller.addCardPageViewModel.addCardFormValidated);
         ...
         */
        addCardFormValidated: function addCardFormValidated() {
         ...
         */
        isCardNumberValidated: function isCardNumberValidated(checkElem) {
            // check if user wants card number validated or not
            if ($(checkElem).is(":checked")) {
                // user wants the card number remotely validated
                ...
                // user does not want card number remotely validated
         ...
         * @param event
         */
        pageContentScrolled: function pageContentScrolled(event) {
            ...
            if (utopiasoftware.saveup.controller.addCardPageViewModel.currentScrollPosition > utopiasoftware.saveup.controller.addCardPageViewModel.previousScrollPosition) {
                // user scrolled up
                // set the current position as previous position
                utopiasoftware.saveup.controller.addCardPageViewModel.previousScrollPosition = utopiasoftware.saveup.controller.addCardPageViewModel.currentScrollPosition;
                ...
                if (140 - utopiasoftware.saveup.controller.addCardPageViewModel.currentScrollPosition <= 56) {
                    ...
                    if (this.isToolBarOpaque != true) {
                        // toolbar has not been made opaque
                        ...
                        $('#add-card-page ons-list-header').css({ "display": "block", "position": "fixed", "top": "56px", "width": "100%" });
            ...
            if (utopiasoftware.saveup.controller.addCardPageViewModel.currentScrollPosition < utopiasoftware.saveup.controller.addCardPageViewModel.previousScrollPosition) {
                ...
                if (140 - utopiasoftware.saveup.controller.addCardPageViewModel.currentScrollPosition > 56) {
                    ...
                    if (this.isToolBarOpaque == true) {
                        // toolbar has NOT been made transparent
        ...
        financialCardValidator: function financialCardValidator(jqxhr) {
            ...
            if (serverResponse.data.brand.toLocaleUpperCase().indexOf("MASTER") >= 0) {
            ...
            if (serverResponse.data.brand.toLocaleUpperCase().indexOf("VISA") >= 0) {
                // brand is a Visa
                // set new card brand as visa
                utopiasoftware.saveup.controller.addCardPageViewModel.newCardBrand = "Visa";
            }
            if (serverResponse.data.brand.toLocaleUpperCase().indexOf("VERVE") >= 0) {
                // brand is a Verve
