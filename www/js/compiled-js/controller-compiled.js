...
$('#app-main-navigator').get(0).pushPage("transfer-cash-page.html",{data:{recipient_details:{recipientAccount:$('#verify-account-page #verify-account-number').val(),recipientBankCode:$('#verify-account-page #verify-account-choose-bank').val()}}});// navigate to the specified page
}else{// inform user that security check failed/user authentication failed
