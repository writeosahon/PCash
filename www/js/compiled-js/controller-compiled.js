...
resolve2,function(message){if(message.indexOf("CONNECTION_FAILED")>-1){resolve2();}else{reject2();}},"https://live.moneywaveapi.co","42 cc 15 61 7d 0e a9 a0 21 26 ef 9a 26 74 b4 27 2a 16 44 41");}));promisesArray.push(new Promise(function(resolve2,reject2){window.plugins.sslCertificateChecker.check(// check ssl certificate for paystack
